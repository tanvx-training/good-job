 ...
 * Configures OAuth2 clients, token settings, and endpoints.
 */
@Configuration
...
public class OAuth2AuthorizationServerConfig {
    ...
    /**
     * Configures the registered client repository.
     *
     * @return the configured RegisteredClientRepository
     */
    @Bean
    public RegisteredClientRepository registeredClientRepository() {
        RegisteredClient goodjobClient = RegisteredClient.withId(UUID.randomUUID().toString())
                .clientId("goodjob-client")
                .clientSecret(passwordEncoder.encode("goodjob-secret"))
        ...
        return new InMemoryRegisteredClientRepository(goodjobClient);
    }

    /**
     * Configures the JWK source for signing tokens.
     *
     ...
     *
     * @param jwkSource the JWKSource to use
